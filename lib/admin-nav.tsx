...
export const ADMIN_NAV_ITEMS: SidebarItem[] = [
  ...
  { label: "PSDs", href: "/admin/psds", icon: <ImageIcon className="h-[18px] w-[18px]" />, disabled: true },
  { label: "Usuários", href: "/admin/usuarios", icon: <Users className="h-[18px] w-[18px]" />, disabled: true },
  { label: "Categorias", href: "/admin/categorias", icon: <FolderTree className="h-[18px] w-[18px]" />, disabled: true },
